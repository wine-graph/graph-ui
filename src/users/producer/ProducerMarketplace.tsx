...
import {PRODUCER_MARKETPLACE_QUERY} from "../../services/producer/producerGraph.ts";
...
export const ProducerMarketplace = () => {
  const {data, loading, error, refetch} = useQuery(PRODUCER_MARKETPLACE_QUERY, {client: producerClient});
