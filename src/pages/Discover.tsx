...
const CountriesList: React.FC = () => {
    ...
    if (error) return <div className="text-red-600">Error loading countries: {error.message}</div>;

    const countries = data?.Domain?.countries ? data.Domain.countries as Country[] : [];
